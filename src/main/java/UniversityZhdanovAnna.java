...
public class UniversityZhdanovAnna {
    ...
    public static List<UniversityZhdanovAnna.TransportTemplate> initBuses() {
        UniversityZhdanovAnna.TransportTemplate bus = new UniversityZhdanovAnna.Bus(23, 56, 13, 34.0, 56.0, 17.0);
    ...
    public static List<UniversityZhdanovAnna.TransportTemplate> initAirplanes() {
        UniversityZhdanovAnna.TransportTemplate airplane = new UniversityZhdanovAnna.Airplane(23, 400, 30, 134.0, 500.0, 17.0);
    ...
    public static List<UniversityZhdanovAnna.TransportTemplate> initFerryBoat() {
        UniversityZhdanovAnna.TransportTemplate ferryBoat = new UniversityZhdanovAnna.FerryBoat(23, 56, 13, 34.0, 56.0, 17.0);
    ...
    public static class TransportTemplate {
        ...
        public void buyoutLuggageSpace(int count, double height, double depth, double width, double weight) {
            if (limitLuggageSpaces - luggageSpaces.size() >= count) {
                for (int i = 0; i < count; i++) {
                    ...
                    UniversityZhdanovAnna.TransportTemplate.Luggage newLuggage = new Luggage(costLuggage, height, depth, width, weight);
        ...
        public void buyoutPlace(int count) {
            if (limitPlaces - places.size() >= count) {
                for (int i = 0; i < count; i++) {
                    UniversityZhdanovAnna.TransportTemplate.Place newPlace = new Place(costPlace);
                    places.add(newPlace);
                }
            } else {
        ...
        public void buyoutVipPlace(int count) {
            if (limitVipPlaces - vipPlaces.size() >= count) {
                for (int i = 0; i < count; i++) {
                    UniversityZhdanovAnna.TransportTemplate.Place newVipPlace = new Place(costVipPlace);
